<div class="container-fluid">
    ...
    <form method="post" action="<?php echo base_url() . 'operator/PesananController/update_status' ?>">
                ...
                <tr>
                    ...
                    <td>&nbsp;
                        ...
                        <select class="form-control" name="status" id="status" required="">
                            <option value="sudah">Pesanan Masuk</option>
                            <option value="cetak">Pesanan Sedang Dicetak</option>
                        </select>
                    </td>
