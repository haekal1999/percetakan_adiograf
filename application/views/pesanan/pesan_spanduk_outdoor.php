<div class="container-fluid">
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?php echo base_url('assets/img/Banner/spanduk_outdoor.jpg') ?>" class="d-block w-100" alt="...">
            </div>
            ...
            <div class="modal-content">
                ...
                <?php foreach ($bahan as $row) { ?>
                    ...
                    <div class="modal-body">
                        ...
                        <img src="<?php echo base_url() . '/assets/img/produk/spanduk_outdoor/bahan/' . $row->foto ?>" class="card-img-top" alt="...">
    ...
    <div class="row">
        ...
        <div class="card col-md-6 ml-5 shadow p-3 mb-5 bg-white rounded mt-5">
            <h2>PESAN SPANDUK OUTDOOR</h2>
            <div class="card-body">
                <div class="row">
                    <?= form_open('spanduk_outdoor', array('enctype' => 'multipart/form-data')) ?>
                        ...
                        <div id="collapseThree" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                            <div class="card-body">
                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="<?php echo base_url('assets/img/produk/spanduk_outdoor/contoh/1.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/spanduk_outdoor/contoh/2.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/spanduk_outdoor/contoh/3.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/spanduk_outdoor/contoh/4.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-4 mt-2 mb-1">
                                                <span>
                                                    <div class="detail-gambar">
                                                        <div class="overlay">
                                                            <img src="<?php echo base_url() . '/assets/img/produk/spanduk_outdoor/bahan/' . $row->foto ?>" class="card-img-top" alt="..." href="<?= $row->id ?>" data-toggle="modal" data-target="#staticBackdrop">
                                                        </div>
                                                    </div>
                                                </span>
                                            </div>
