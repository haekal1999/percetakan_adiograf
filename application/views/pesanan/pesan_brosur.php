    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?php echo base_url('assets/img/Banner/brosur.jpg') ?>" class="d-block w-100" alt="...">
            </div>
            ...
            <div class="modal-content">
                ...
                <?php foreach ($bahan as $row) { ?>
                    ...
                    <div class="modal-body">
                        ...
                        <img src="<?php echo base_url() . '/assets/img/produk/brosur/bahan/' . $row->foto ?>" class="card-img-top" alt="...">
            ...
            <div class="modal-content">
                ...
                <?php foreach ($finishing as $row) { ?>
                    ...
                    <div class="modal-body">
                        ...
                        <img src="<?php echo base_url() . '/assets/img/produk/brosur/finishing/' . $row->foto ?>" class="card-img-top" alt="...">
                    </div>
                <?php } ?>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php foreach ($laminasi as $row) { ?>
                    ...
                    <div class="modal-body">
                        <h6 class="card-title ml-2"><?= $row->nama ?></h6>
                        <img src="<?php echo base_url() . '/assets/img/produk/brosur/laminasi/' . $row->foto ?>" class="card-img-top" alt="...">
                    </div>
                <?php } ?>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    ...
                    <div class="perhitungan">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="finishing1" id="finishing1" required>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="laminasi1" id="laminasi1" required>
                            ...
                            <div class="form-group">
                                <label>Finishing Lipatan : </label>

                                <select class="form-control" name="lipatan" id="lipatan" required>
                                    <option disabled selected value="">Pilih Lipatan</option>
                                    <?php
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="card-body">
                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="<?php echo base_url('assets/img/produk/brosur/contoh/1.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/brosur/contoh/2.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/brosur/contoh/3.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/brosur/contoh/4.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                    </div>
                                                ...
                                                <span>
                                                    <div class="detail-gambar">
                                                        <div class="overlay">
                                                            ...
                                                            <img src="<?php echo base_url() . '/assets/img/produk/brosur/bahan/' . $row->foto ?>" class="card-img-top" alt="..." href="<?= $row->id ?>" data-toggle="modal" data-target="#staticBackdrop">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-md-4 mt-2 ">
                                                <span>
                                                    <div class="detail-gambar">
                                                        <div class="overlay">
                                                            <img src="<?php echo base_url() . '/assets/img/produk/brosur/finishing/' . $row->foto ?>" class="card-img-top" alt="..." href="<?= $row->id ?>" data-toggle="modal" data-target="#finishing">
                                                        </div>
                                                    </div>
                                                </span>
                                            </div>
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-md-4 mt-1">
                                                <span>
                                                    <div class="detail-gambar">
                                                        <div class="overlay">
                                                            <img src="<?php echo base_url() . '/assets/img/produk/brosur/laminasi/' . $row->foto ?>" class="card-img-top" alt="..." href="<?= $row->id ?>" data-toggle="modal" data-target="#laminasi">
                                                        </div>
                                                    </div>
                                                </span>
                                            </div>
...
<script type="text/javascript">
    $(".perhitungan").keyup(function() {
        ...
        if (finishing === 'satu sisi') {
            ...
            total = (harga + hrg_laminasi) * jumlah * 2;
            html = '' +
                '<h3> Rp. ' + formatRupiah(parseInt(total).toString()) + '</h3>';
            $('#total').html(html);
        }
