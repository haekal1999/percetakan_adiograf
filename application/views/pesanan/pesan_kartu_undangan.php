                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="ukuran" id="ukuran" required="">
                                    ...
                                    <option value="A6">A6 (14.8 x 10.5 cm)</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="orientasi" id="orientasi" required>
                                    <option disabled selected value="">Pilih Orientasi</option>
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="card-body">
                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="<?php echo base_url('assets/img/produk/contoh/1.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/contoh/2.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/contoh/3.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/contoh/PPG_-_BAHAN_KARTU_UNDANGAN.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/contoh/PPG_-_UKURAN_KARTU_UNDANGAN.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                    </div>
...
<script type="text/javascript">
    $(".perhitungan").keyup(function() {
        ...
        var html = '';
        if (ukuran === 'A5') {
            var ukuran1 = parseInt('2000');
        } else if (ukuran === 'A6') {
            var ukuran1 = parseInt('0');
        }

        if (finishing === 'satu sisi') {
            total = (harga + hrg_laminasi + ukuran1) * jumlah * 1;
            html = '' +
                '<h3> Rp. ' + formatRupiah(parseInt(total).toString()) + '</h3>';
            $('#total').html(html);
        } else if (finishing === 'dua sisi') {
            total = (harga + hrg_laminasi + ukuran1) * jumlah * 2;
            html = '' +
                '<h3> Rp. ' + formatRupiah(parseInt(total).toString()) + '</h3>';
            $('#total').html(html);
