<div class="container-fluid">
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?php echo base_url('assets/img/Banner/kartu_nama.jpg') ?>" class="d-block w-100" alt="...">
            </div>
    ...
    <!-- Modal Sudut -->
    <div class="modal fade" id="sudut" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Detail Sudut</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <?php foreach ($sudut as $row) { ?>

                    <div class="modal-body">
                        <h6 class="card-title ml-2"><?= $row->sudut ?></h6>
                        <img src="<?php echo base_url() . '/assets/img/produk/sudut/' . $row->foto ?>" class="card-img-top" alt="...">
    ...
    <div class="row">
        ...
        <div class="card col-md-6 ml-5 shadow p-3 mb-5 bg-white rounded mt-5">
            <h2>PESAN KARTU NAMA</h2>
            <div class="card-body">
                <div class="row">
                    <?= form_open('kartu_nama', array('enctype' => 'multipart/form-data')) ?>
                    <div class="perhitungan">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label>Tipe Sudut : </label>

                                <select class="form-control" name="sudut" id="sudut" required>
                                    <option disabled selected value="">Pilih Tipe Sudut</option>
                                    <?php
                                    foreach ($sudut as $row) {
                                    ?>
                                        <option value="<?php echo $row->sudut ?>"><?php echo $row->sudut ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="card-body">
                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="<?php echo base_url('assets/img/produk/contoh/card1-konvert-1.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/contoh/card2-konvert-1.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/contoh/card3-konvert-1.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/contoh/card4-konvert.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                    </div>
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-md-4 mt-2 ">
                                                <span>
                                                    <div class="detail-gambar">
                                                        <div class="overlay">
                                                            <img src="<?php echo base_url() . '/assets/img/produk/sudut/' . $row->foto ?>" class="card-img-top" alt="..." href="<?= $row->id ?>" data-toggle="modal" data-target="#sudut">
                                                        </div>
                                                    </div>
                                                </span>
                                            </div>
