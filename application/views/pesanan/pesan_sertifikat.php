<div class="container-fluid">
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?php echo base_url('assets/img/Banner/sertifikat.jpg') ?>" class="d-block w-100" alt="...">
            </div>
    ...
    <div class="row">
        ...
        <div class="card col-md-6 ml-5 shadow p-3 mb-5 bg-white rounded mt-5">
            <h2>PESAN SERTIFIKAT</h2>
            <div class="card-body">
                <div class="row">
                    <?= form_open('sertifikat', array('enctype' => 'multipart/form-data')) ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="ukuran" id="ukuran" required="">
                                    ...
                                    <option value="F4">F4 (21.6 x 33 cm)</option>
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="card-body">
                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="<?php echo base_url('assets/img/produk/contoh/sertif1.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/contoh/sertif2.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/contoh/sertif3.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/contoh/sertif4.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                    </div>
