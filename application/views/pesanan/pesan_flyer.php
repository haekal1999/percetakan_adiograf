<div class="container-fluid">
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?php echo base_url('assets/img/Banner/flyer.jpg') ?>" class="d-block w-100" alt="...">
            </div>
            ...
            <div class="modal-content">
                ...
                <?php foreach ($bahan as $row) { ?>
                    ...
                    <div class="modal-body">
                        ...
                        <img src="<?php echo base_url() . '/assets/img/produk/flyer/bahan/' . $row->foto ?>" class="card-img-top" alt="...">
            ...
            <div class="modal-content">
                ...
                <?php foreach ($finishing as $row) { ?>
                    ...
                    <div class="modal-body">
                        ...
                        <img src="<?php echo base_url() . '/assets/img/produk/flyer/finishing/' . $row->foto ?>" class="card-img-top" alt="...">
                    </div>
                <?php } ?>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <div class="row">
        ...
        <div class="card col-md-6 ml-5 shadow p-3 mb-5 bg-white rounded mt-5">
            ...
            <div class="card-body">
                <div class="row">
                    <?= form_open('flyer', array('enctype' => 'multipart/form-data')) ?>
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="card-body">
                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="<?php echo base_url('assets/img/produk/flyer/contoh/1.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/flyer/contoh/2.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/flyer/contoh/3.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url('assets/img/produk/flyer/contoh/3.jpg') ?>" class="d-block w-100" alt="...">
                                        </div>
                                                ...
                                                <span>
                                                    <div class="detail-gambar">
                                                        <div class="overlay">
                                                            ...
                                                            <img src="<?php echo base_url() . '/assets/img/produk/flyer/bahan/' . $row->foto ?>" class="card-img-top" alt="..." href="<?= $row->id ?>" data-toggle="modal" data-target="#staticBackdrop">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-md-4 mt-3">
                                                <span>
                                                    <div class="detail-gambar">
                                                        <div class="overlay">
                                                            <img src="<?php echo base_url() . '/assets/img/produk/flyer/finishing/' . $row->foto ?>" class="card-img-top" alt="..." href="<?= $row->id ?>" data-toggle="modal" data-target="#finishing">
                                                        </div>
                                                    </div>
                                                </span>
                                            </div>
