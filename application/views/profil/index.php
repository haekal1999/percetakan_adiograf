				...
				<div class="row">
					<div class="col-md-8">
						...
						<div class="form-group">
							...
							<input type="text" name="nama" class="form-control" placeholder="Nama" required autocomplete="off" value="<?= $this->session->userdata('nama'); ?>">
						</div>
						<div class="form-group">
							<label for="">Username :</label>
							<input type="text" name="username" class="form-control" required autocomplete="off" value="<?= $this->session->userdata('username'); ?>" readonly>
						</div>
						<div class="form-group">
							<label for="">Nomor HP :</label>
							<input type="number" name="no_hp" class="form-control" placeholder="Nomor HP" required autocomplete="off" value="<?= $this->session->userdata('no_hp'); ?>">
						</div>
						<div class="form-group">
							<label for="">Email :</label>
							<input type="email" name="email" class="form-control" placeholder="Email" required autocomplete="off" value="<?= $this->session->userdata('email'); ?>">
						</div>
