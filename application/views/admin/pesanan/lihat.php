						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a href="<?= base_url('admin/pesanan/foto/' . $value['xbanner_id']) ?>" class="badge badge-primary"><i class="fa fa-eye"></i> Lihat</a>
									</td>
								</tr>
							<?php
								$no++;
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a href="<?= base_url('admin/pesanan/foto/' . $value['spanduk_outdoor_id']) ?>" class="badge badge-primary"><i class="fa fa-eye"></i> Lihat</a>
									</td>
								</tr>
							<?php
								$no++;
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a href="<?= base_url('admin/pesanan/foto/' . $value['flyer_id']) ?>" class="badge badge-primary"><i class="fa fa-eye"></i> Lihat</a>
									</td>
								</tr>
							<?php
								$no++;
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a href="<?= base_url('admin/pesanan/foto/' . $value['brosur_id']) ?>" class="badge badge-primary"><i class="fa fa-eye"></i> Lihat</a>
									</td>
								</tr>
							<?php
								$no++;
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a href="<?= base_url('admin/pesanan/foto/' . $value['kartu_nama_id']) ?>" class="badge badge-primary"><i class="fa fa-eye"></i> Lihat</a>
									</td>
								</tr>
							<?php
								$no++;
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a href="<?= base_url('admin/pesanan/foto/' . $value['undangan_id']) ?>" class="badge badge-primary"><i class="fa fa-eye"></i> Lihat</a>
									</td>
								</tr>
							<?php
								$no++;
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a href="<?= base_url('admin/pesanan/foto/' . $value['sertifikat_id']) ?>" class="badge badge-primary"><i class="fa fa-eye"></i> Lihat</a>
									</td>
								</tr>
							<?php
								$no++;
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a href="<?= base_url('admin/pesanan/foto/' . $value['kalender_id']) ?>" class="badge badge-primary"><i class="fa fa-eye"></i> Lihat</a>
									</td>
								</tr>
							<?php
								$no++;
