				...
				<table width="100%">
					<tr>
						<td><b>Status Pembayaran &nbsp; :</b>
							...
							<?php elseif ($transaksi['faktur_status'] == 'tidak_sesuai') : ?>
				...
				<div>
					<table width="100%">
						...
						<tr>
							...
							<td> :</td>
							<td>&nbsp;
								<img src="<?= base_url('assets/img/struk/' . $konfirmasi['konfirmasi_struk']) ?>" width="50%" alt="Struk">
							</td>
						</tr>
						<tr>
							<td></td>
							...
							<td><?php
								if ($konfirmasi['konfirmasi_nominal'] == $transaksi['keranjang_total']) :
									if ($transaksi['faktur_status'] != 'sudah') : ?>
										...
										<a href="<?= base_url('admin/transaksi/konfirmasi_tdk_sesuai/' . $transaksi['faktur_id']) ?>" class="btn btn-warning ml-2" onclick="return confirm('Pembayaran Tidak Sesuai? ')"><i class="fa fa-times"></i> Nominal Tidak Sesuai</a>
									...
									<a href="<?= base_url('admin/transaksi/konfirmasi_tdk_sesuai/' . $transaksi['faktur_id']) ?>" class="btn btn-warning ml-2" onclick="return confirm('Pembayaran Tidak Sesuai? ')"><i class="fa fa-check"></i> Nominal Tidak Sesuai</a>
